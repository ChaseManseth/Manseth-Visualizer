...
// Changes the color of the upload button and adds a hover tint
function uploadBtnColorChange(rgb) {
    var currentR = rgb.r;
    var currentG = rgb.g;
    var currentB = rgb.b;

    // Text Color
    $(".uploadbtn").css("color", "rgb(" + currentR + "," + currentG + "," + currentB + ")");

    // Border Color
    $(".uploadbtn").css("border-color", "rgb(" + currentR + "," + currentG + "," + currentB + ")");
}

// Get the new tinted colors
function tintUploadBtn(rgb) {
    var currentR = rgb.r;
    var currentG = rgb.g;
    var currentB = rgb.b;
    var tint_factor = 0.5;
    ...
    // Set the new values
    var newR = Math.floor(currentR + (255 - currentR) * tint_factor);
    var newG = Math.floor(currentG + (255 - currentG) * tint_factor);
    var newB = Math.floor(currentB + (255 - currentB) * tint_factor);
